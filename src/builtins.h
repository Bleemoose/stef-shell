 ...
 * child. This is mandatory for anything that mutates shell state (cd, export,
 * exit) -- a child's chdir/setenv/exit would die with the child and leave the
 * parent unchanged. It's also nice-to-have for cheap introspection (pwd, env,
 * help, status) because skipping fork/exec is a real latency win.
 *
